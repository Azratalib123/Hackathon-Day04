...
const FaqPage = () => {
  ...
  return (
    <div className="bg-[#FCF8F3] min-h-screen">
      <header className="bg-[#0c0a09] h-60 flex items-center justify-center">
      ...
      <main className="container mx-auto px-6 py-12">
        <div className="space-y-10">
          ...
          <form onSubmit={handleQuestionSubmit} className="flex flex-col gap-5 mt-4">
            ...
            <button
              type="submit"
              className="bg-[#0c0a09] text-white font-bold p-3 rounded-md hover:bg-[#44403c] transition-colors"
            >
              Submit Question
            </button>
          </form>
