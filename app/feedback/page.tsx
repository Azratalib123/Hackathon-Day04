...
const FeedbackPage = () => {
  ...
  return (
    <div className="bg-[#FCF8F3] min-h-screen">
      <header className="bg-[#18181b] h-60 flex items-center justify-center">
      ...
      <main className="container mx-auto px-6 py-12">
        <div className="space-y-8">
          ...
          <form onSubmit={handleFeedbackSubmit} className="flex flex-col gap-6 mt-6">
            ...
            <button
              type="submit"
              className="bg-[#18181b] text-white font-bold p-3 rounded-md hover:bg-[#27272a] transition-colors"
            >
              Submit Feedback
            </button>
          </form>
